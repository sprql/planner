defmodule Planner.Web.Todo.ItemControllerTest do
  ...
  test "creates resource and redirects when data is valid", %{conn: conn} do
    ...
    assert Repo.get_by(Todo.Item, @valid_attrs)
  end
  ...
  test "shows chosen resource", %{conn: conn} do
    todo_item = Repo.insert! %Todo.Item{}
  ...
  test "deletes chosen resource", %{conn: conn} do
    ...
    assert redirected_to(conn) == todo_item_path(conn, :index)
    refute Repo.get(Todo.Item, todo_item.id)
  end
end
